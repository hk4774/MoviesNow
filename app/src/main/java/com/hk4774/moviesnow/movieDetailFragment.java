...
import com.hk4774.moviesnow.constants.constant;
import com.hk4774.moviesnow.database.favouritesSqliteHelper;
import com.hk4774.moviesnow.modal.movieGeneralModal;
import com.hk4774.moviesnow.modal.review.Results;
import com.hk4774.moviesnow.modal.review.movieReview;
import com.hk4774.moviesnow.modal.trailer.movieYoutubeModal;
import com.hk4774.moviesnow.network.MovieAPI;
import com.hk4774.moviesnow.network.NetworkAPI;
    ...
    protected void getTrailer(final LinearLayout youtubeViewHolder) {
        ...
        mMovieAPI.fetchVideos(constant.ACCESS_TOKEN, this.moviegeneralModal.getmId(), new Callback<movieYoutubeModal>() {
            ...
            public void success(movieYoutubeModal movieYoutubeModal, Response response) {
                ...
                com.hk4774.moviesnow.modal.trailer.Results[] trailer = movieYoutubeModal.getResults();
                if (trailer.length > 0) {
                    shareYoutubeID = trailer[0].getKey();
                    for (final com.hk4774.moviesnow.modal.trailer.Results obj : trailer) {
